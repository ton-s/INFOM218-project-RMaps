...
Dans notre situation, nous allons examiner l'application Android appelée **RMaps**. Cette application a été entièrement développée en utilisant le langage Java et vise à permettre la visualisation de cartes géographiques de diverses natures.
...
L'étape 2 contient :
- Le sous schéma logique réellement utilisé par le programme
- Les statistiques détaillées sur les requêtes de la base de données

### Step 3 & 4

Toutes les informations sont présentes dans le rapport
